...
const Navbar = () => {
  ...
  return (
     <div className={`flex z-30 sm:w-[80%] w-[95%]  justify-between transition-all duration-600 fixed top-0 items-center left-1/2 -translate-x-1/2   bg-black/50 backdrop-blur-3xl ${scroll?'rounded-xl top-2.5 border sm:h-20 border-white/30':'border  border-black border-b-white/30 border-x-white/30 h-15  rounded-b-xl'} `}>
      <Navleft/>
      <div className='sm:flex justify-center  gap-3 items-center hidden'>
